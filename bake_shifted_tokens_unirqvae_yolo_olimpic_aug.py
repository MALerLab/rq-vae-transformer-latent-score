...
if __name__ == "__main__":
  ...
  image_path_list = list(Path("/home/sake/userdata/olimpic_dataset_synthaug/olimpic-1.0-synthetic_1/").rglob("*.png"))
  ...
  for image_path in tqdm(image_path_list):
    ...
    # 9 times of different augmentations. 0 is no augmentation.
    augmented_imgs = []
    for a in range(6):
